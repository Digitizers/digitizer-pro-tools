...
class DPT_RMB_Admin {
	...
	public function handle_save() {
		...
		// Each field is sanitized by the settings class; the array itself
		// only needs unslashing.
		$data = isset( $_POST['dpt_rmb'] ) && is_array( $_POST['dpt_rmb'] ) ? wp_unslash( $_POST['dpt_rmb'] ) : array(); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Sanitized per field in the settings class.
