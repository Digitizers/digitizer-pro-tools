...
class DPT_WCC_Admin {
	...
	public function handle_save() {
		...
		$data = isset( $_POST['dpt_wcc'] ) && is_array( $_POST['dpt_wcc'] ) ? wp_unslash( $_POST['dpt_wcc'] ) : array(); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Sanitized per field in the settings class.
