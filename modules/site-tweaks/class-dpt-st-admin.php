...
class DPT_ST_Admin {
	...
	public function handle_save() {
		...
		$data = isset( $_POST['dpt_st'] ) && is_array( $_POST['dpt_st'] ) ? wp_unslash( $_POST['dpt_st'] ) : array(); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Sanitized per field in the settings class.
