...
class DPT_DP_Admin {
	...
	public function handle_save() {
		...
		$data = isset( $_POST['dpt_dp'] ) && is_array( $_POST['dpt_dp'] ) ? $_POST['dpt_dp'] : array(); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput -- Sanitized per field in the settings class.
