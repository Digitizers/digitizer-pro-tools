...
dpt_test_eq( DPT_SK_Enforce::cache_header_for( array( 'Cache-Control: max-age=99999, s-maxage=99999' ) ), 'Cache-Control: max-age=' . min( HOUR_IN_SECONDS, $shabbat['start'] - $clock ) . ', s-maxage=99999', 'only the max-age value is shortened, other directives kept' );
